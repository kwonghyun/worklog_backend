...
public class CalendarController {
    ...
    @GetMapping("/years")
    public ResponseEntity<ResourceResponseDto<YearResponseDto>> readYears(Authentication auth) {
        YearResponseDto dto = calendarService.readYears(auth.getName());
    ...
    public ResponseEntity<ResourceResponseDto<MonthResponseDto>> readMonths(
        ...
        MonthResponseDto responseDto = calendarService.readMonths(requestDto, auth.getName());
    ...
    public ResponseEntity<ResourceResponseDto<DayResponseDto>> readDays(
        ...
        DayResponseDto responseDto = calendarService.readDays(requestDto, auth.getName());
